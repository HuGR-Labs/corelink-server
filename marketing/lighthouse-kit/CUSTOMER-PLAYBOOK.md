...
Subject to our responsible-disclosure policy. Email `security@humangr.com` before any probing. We have not engaged an external pentest firm, so there is no third-party summary to share; under NDA we can share the executive summary under NDA.
