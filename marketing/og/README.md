...
|-----------------------------|------------------------------------------|--------------------|----------------------------------------------------|
| `corelink-server.png`       | `humangr-labs/corelink-server`           | CoreLink           | REAPI v2 build cache. BYOK. Verifiable audit log.  |
| `corelink-cli.png`          | `humangr-labs/corelink-cli`              | corelink CLI       | Bazel · Buck2 · Cargo · npm · OCI                  |
| `corelink-bazel-example.png`| `humangr-labs/corelink-bazel-example`    | CoreLink + Bazel   | 5-minute setup walkthrough                         |
...
1. https://github.com/humangr-labs/corelink-server/settings → **Social preview** → Edit → Upload an image
2. https://github.com/humangr-labs/corelink-cli/settings → **Social preview** → Edit → Upload an image
