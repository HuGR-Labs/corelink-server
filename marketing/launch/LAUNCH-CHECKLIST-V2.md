...
| L23 | T-0 06:00:30 PT | Trust center unlock | VPSec | Unlock TLA+ specs, SBOM, pentest letter (NDA-gated download), DPA package at `corelink.humangr.com/trust`. | All 4 assets behind their gates load on incognito. | If NDA-gated download breaks: temporarily route to email-on-request; do not expose pentest letter publicly. |
