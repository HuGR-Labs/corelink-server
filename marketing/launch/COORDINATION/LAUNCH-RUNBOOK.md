...
|---|---|---|---|
| T-7d | **External pentest status reconfirmed as NOT COMMISSIONED** — verify every vendor in `reports/pentest-rfp-tracker.json` is `NOT_CONTACTED`, and that no launch asset claims otherwise — `EVT-040`. | Security Lead | Tracker verified; zero pentest claims in launch copy. |
...
| T-0 06:00 PT | **Trust center embargoed assets** unlocked: TLA+ specs, SBOM, DPA package. (No pentest summary letter — none has been commissioned.) | Marketing + Trust Engineering |
