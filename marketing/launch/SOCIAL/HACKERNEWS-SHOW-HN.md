...
- **Engineering gate is separated from launch orchestration.** GA will be decided by a binary engineering gate (PRR + completed external pentest with retest + 30d sustained staging + 3 lighthouse customers attested + zero CRITICAL waivers), not by marketing readiness. The external pentest remains planned; no vendor has been contracted or report issued today. Splitting those two gates was a discipline we wanted to bake in from the start.
