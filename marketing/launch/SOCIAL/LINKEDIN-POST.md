...
**1. We split GA into two gates.** An engineering gate that is binary and unappealable — PRR globally approved, 30 days of sustained staging, three lighthouse customers with SLA met, SOC 2 gap analysis delivered, zero active waivers in CRITICAL controls. And a launch orchestration gate — this post, the press release, the blog series — which is soft and could shift its date without affecting the engineering decision. The engineering gate gated the launch. Not the other way around.
