...
>
> 1. Engineering gate (binary, unappealable): PRR + completed external pentest + 30d staging + 3 lighthouse customers + zero CRITICAL waivers. The pentest remains planned; no vendor has been contracted or report issued today.
