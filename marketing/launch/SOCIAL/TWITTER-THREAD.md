...
>
> 1. Engineering gate (binary, unappealable): PRR + 30d staging + 3 lighthouse customers + zero CRITICAL waivers. (No external pentest — we have not commissioned one, and we are not going to pretend we did.)
