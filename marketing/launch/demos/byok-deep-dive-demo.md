...
**Lane:** browser navigates to the public Trust Center (`corelink-docs.humangr.com/trust`) **and** the tenant overview (`/en/admin/tenants/acme-prod`).
