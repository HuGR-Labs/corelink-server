...
**Submission URL field:** `https://signup.corelink.dev/pilot`
...
- **Flagging risks:** the "Show HN" prefix is reserved for things people can actually try. The signup page being token-gated is fine, but the landing page MUST not 404 at submission time. Verify `signup.corelink.dev/pilot` resolves before clicking submit.
