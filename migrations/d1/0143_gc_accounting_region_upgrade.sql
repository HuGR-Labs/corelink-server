...
DROP TRIGGER IF EXISTS trg_gc_purge_accounting_required; -- additive-allowed: ADR-0103 replace the deployed B-071 accounting guard
...
DROP TRIGGER IF EXISTS trg_gc_purge_finalize_accounting; -- additive-allowed: ADR-0103 replace the deployed B-071 accounting finalizer
