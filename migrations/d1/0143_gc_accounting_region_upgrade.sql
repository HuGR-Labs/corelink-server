...
DROP TRIGGER IF EXISTS trg_gc_purge_accounting_required; -- additive-trigger-replacement: ADR-0143 B-071 historic accounting body
...
DROP TRIGGER IF EXISTS trg_gc_purge_finalize_accounting; -- additive-trigger-replacement: ADR-0143 B-071 historic accounting body
