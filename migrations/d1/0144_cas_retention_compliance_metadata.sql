...
CREATE INDEX IF NOT EXISTS idx_cas_retention_tenant_expiry ON cas_retention (tenant_id, retain_until_ms);
CREATE INDEX IF NOT EXISTS idx_cas_retention_tenant_mode ON cas_retention (tenant_id, mode, region);
