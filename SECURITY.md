...
- Customer-facing portal: <https://corelink.dev/security/policy>
- RFC 9116 contact card: <https://corelink.dev/.well-known/security.txt>
...
- **PGP key fingerprint:** `TBD` — key is published at
  <https://corelink.dev/.well-known/security-pgp.asc> once the program goes
  live. Encrypt high-impact reports.
- **Subject prefix:** `[VULN]` followed by a short description.

### Alternative: web form

- <https://corelink.dev/.well-known/security-report> (form posts directly
...
- A **place in our Hall of Fame**: <https://corelink.dev/security/hall-of-fame>.
...
- Reports that violate the law or our [Terms of Service](https://corelink.dev/legal/terms).
...
- Customer-facing policy: <https://corelink.dev/security/policy>
