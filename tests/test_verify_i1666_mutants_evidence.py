...
class HostedMutantsEvidenceContractTest(unittest.TestCase):
    ...
    def test_evidence_contract_rejects_boundary_mutations(self) -> None:
        mutations = (
            ...
            ("TOTAL_RUNNER_MINUTE_CAP: 8200", "TOTAL_RUNNER_MINUTE_CAP: 8199"),
            ("HISTORICAL_RECONCILED_INVENTORY_OCCURRENCES: 24469", "HISTORICAL_RECONCILED_INVENTORY_OCCURRENCES: 24463"),
            ("max-parallel: 9", "max-parallel: 27"),
            ("timeout-minutes: 255", "timeout-minutes: 254"),
            ("timeout-minutes: 240", "timeout-minutes: 239"),
            ("--jobs=8", "--jobs=1"),
            ...
            ("prior_baseline_run_id:", "prior_campaign_run_id:"),
            ("name: verify retained prior baseline-only receipt", "name: verify retained prior baseline receipt"),
            ("corelink.hosted-mutants-baseline-qualification.v1", "corelink.hosted-mutants-baseline-qualification.v0"),
