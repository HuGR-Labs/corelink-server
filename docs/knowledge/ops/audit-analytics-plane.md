...
checkpoint_sha: "f1c7a04969e8a90ad67fb47d6b673d4cf480bb36"
provenance: "AUTHORED"
...
20. `crates/corelink-container/src/routes/audit_drain.rs:1423-1552` — `handle_drain`: LIVE S-09 `POST /_internal/audit/drain` entry (partition scan → seal → summary).
