...
3c. `crates/corelink-container/src/routes/tier_select.rs:891-895` — runner checkout SKIPS the cache `persist_pending_checkout` (`!tier.is_runner()` guard).
