...
8. `crates/corelink-container/src/storage/r2_s3.rs:1215` — `verify_content_hash`, widened to `pub(crate)` and reused as the single enforcement point.
