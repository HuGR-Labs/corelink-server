...
- `crates/corelink-container/src/routes/ac.rs:533` — `state.lookup.lookup(req)` delegation.
- `crates/corelink-container/src/routes/ac.rs:614` — `state.update.update(req)` delegation.
...
- `crates/corelink-container/src/customer_d1.rs:919` — `impl CustomerOverviewHandler for D1CustomerHandler` (live production impl).
- `crates/corelink-container/src/customer_d1.rs:1058` — `impl CustomerBillingHandler for D1CustomerHandler`.
