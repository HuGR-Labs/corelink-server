...
- `crates/corelink-container/src/byte_accounting/b126_m2_impl_01.rs:760` — reserves bytes (`block_on_accrue`) before `write_inner.write(req)`.
- `crates/corelink-container/src/byte_accounting/b126_m2_impl_01.rs:805` — `impl CasDeleteHandler for AccountingCasHandler`.
