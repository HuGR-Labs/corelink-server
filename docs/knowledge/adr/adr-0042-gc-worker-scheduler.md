...
checkpoint_sha: "6b89bb728836dc86f6bacd5ae1744ce1afa2a218"
provenance: "AUTHORED"
...
5. `specs/03_architecture/adrs/ADR-0042-gc-worker-scheduler.md:394-410` — §A3 addendum: the TLA+ formal-verification scope (mark-sweep proven; grace window covered architecturally).
