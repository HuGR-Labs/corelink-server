...
5. `specs/03_architecture/adrs/ADR-0042-gc-worker-scheduler.md:397-413` — §A3 addendum: the TLA+ formal-verification scope (mark-sweep proven; grace window covered architecturally). The range moved when §A1 recorded the 2026-08-24 TLC re-pin; the scope claim itself is unchanged.
