...
checkpoint_sha: "233ebecc699975265f8821d749e0d8ca2f29c0be"
provenance: "AUTHORED"
...
8. `specs/03_architecture/adrs/ADR-S34-001-cas-read-integrity-before-streaming.md:175-202` — addendum 1: a BYOK-active tenant's object is ciphertext, the re-verify must run on plaintext, and gated-inert BYOK makes a naive scrubber correct today and wrong later.
