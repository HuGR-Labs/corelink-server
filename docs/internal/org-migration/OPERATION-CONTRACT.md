...
| G19 | Observação completa; grants temporários de human/collaborator/team/app/token reconciliados, obsoletos revogados com negativas, readers retidos owner/reason/expiry/reviewer individual, source bridge removido e readback `OBSERVED_ABSENT`; recibo/backlog atualizados. |
