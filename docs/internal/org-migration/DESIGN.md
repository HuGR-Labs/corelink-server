...
A entrega não migra consumidores de produção. WP-02 deve mapear cada consumidor ativo a uma projeção explícita e testar a origem e as topologias transitórias. Diretrizes:
