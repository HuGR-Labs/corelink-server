...
| Sentry | <https://sentry.io/astro-assets/resources/legal/how-to-comply-with-gdpr-october-2024.pdf> | Sentry's October 2024 first-party GDPR material says SOC 2 Type 2 and ISO 27001 reports are available in the customer legal/compliance area. | No customer-area report or signed CoreLink DPA was retrieved; VR-7 remains open. The dated source does not establish a current 2026 report. |
...
| Better Stack | <https://betterstack.com/security> and <https://betterstack.com/enterprise> | Better Stack's security page states SOC 2 Type 2 compliance and says its latest report is available on request; its first-party enterprise page says the SOC 2 Type 2 attestation is provided upon signing an NDA. | No report, signed CoreLink DPA, or Legal review was retrieved; VR-9 remains open. |
