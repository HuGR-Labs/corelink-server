...
**Manifesto:** `crates/corelink-client-verify/fuzz/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
2 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-client-verify/fuzz/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-client-verify/fuzz/fuzz_targets/verify_ffi.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-client-verify/fuzz/fuzz_targets/verify_ffi.rs)
- [`crates/corelink-client-verify/fuzz/fuzz_targets/verify_sync.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-client-verify/fuzz/fuzz_targets/verify_sync.rs)
...
- [crates/corelink-client-verify/fuzz/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-client-verify/fuzz/Cargo.toml); blob `7ee20e2fda1293652cc61956564417fba67b2047`.
- [crates/corelink-client-verify/fuzz/fuzz_targets/verify_ffi.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-client-verify/fuzz/fuzz_targets/verify_ffi.rs); blob `8c92361ea688b2eea7b7ea10d067dd83c3e1501b`.
- [crates/corelink-client-verify/fuzz/fuzz_targets/verify_sync.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-client-verify/fuzz/fuzz_targets/verify_sync.rs); blob `300ebb46f66d8d6b355b77ecbce836f879aa28bf`.
