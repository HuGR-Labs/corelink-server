...
**Manifesto:** `crates/tenant-path/fuzz/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
2 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/tenant-path/fuzz/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/tenant-path/fuzz/fuzz_targets/derive_prefix.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/tenant-path/fuzz/fuzz_targets/derive_prefix.rs)
- [`crates/tenant-path/fuzz/fuzz_targets/derive_prefix_extended.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/tenant-path/fuzz/fuzz_targets/derive_prefix_extended.rs)
...
- [crates/tenant-path/fuzz/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/tenant-path/fuzz/Cargo.toml); blob `aaeeb71ed797939dfa745450b5a4640ef344e579`.
- [crates/tenant-path/fuzz/fuzz_targets/derive_prefix.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/tenant-path/fuzz/fuzz_targets/derive_prefix.rs); blob `465fcb908f422101e87e4e7662e13e0dfaf77d97`.
- [crates/tenant-path/fuzz/fuzz_targets/derive_prefix_extended.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/tenant-path/fuzz/fuzz_targets/derive_prefix_extended.rs); blob `fa2a23560b4af0f5070363de6294e9b751228134`.
