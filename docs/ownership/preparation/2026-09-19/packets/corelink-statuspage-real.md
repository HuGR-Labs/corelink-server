...
**Manifesto:** `crates/corelink-statuspage-real/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
4 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-statuspage-real/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-statuspage-real/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-statuspage-real/src/lib.rs)
...
- [crates/corelink-statuspage-real/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-statuspage-real/Cargo.toml); blob `4fe081a3c13c920292a43ff0772e5fa7cd0e4420`.
- [crates/corelink-statuspage-real/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-statuspage-real/src/lib.rs); blob `36268b916b8ebe88116b9584e6083679b4297c10`.
