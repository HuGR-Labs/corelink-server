...
2 targets enumerados em `../census.json`, registro cujo `manifest` é `tests/e2e-replication-failover/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.
