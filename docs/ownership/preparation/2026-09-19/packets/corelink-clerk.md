...
**Manifesto:** `crates/corelink-clerk/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
10 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-clerk/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-clerk/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-clerk/src/lib.rs)
...
- [crates/corelink-clerk/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-clerk/Cargo.toml); blob `39273401e870c591c591dd7258b9eb44167384c2`.
- [crates/corelink-clerk/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-clerk/src/lib.rs); blob `66d6db966cc4c6f6fa261e9f3db5f8bbb8bb7ef0`.
