...
**Manifesto:** `tests/e2e-chaos/Cargo.toml`. **Baseline:** `37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5`.
...
13 targets enumerados no [censo completo](../census.json), registro cujo `manifest` é `tests/e2e-chaos/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`tests/e2e-chaos/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tests/e2e-chaos/src/lib.rs)
...
- [tests/e2e-chaos/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tests/e2e-chaos/Cargo.toml); blob `df80446c32ba222ae2ff66ada6b6ff5ae50bfe40`.
- [tests/e2e-chaos/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tests/e2e-chaos/src/lib.rs); blob `3e985bee6c4c39075a2df09adedfb8ae7514c98d`.
