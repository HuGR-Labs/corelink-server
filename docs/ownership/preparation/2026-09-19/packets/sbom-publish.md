...
**Manifesto:** `tools/sbom-publish/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
7 targets enumerados em `../census.json`, registro cujo `manifest` é `tools/sbom-publish/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`tools/sbom-publish/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tools/sbom-publish/src/lib.rs)
- [`tools/sbom-publish/src/main.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tools/sbom-publish/src/main.rs)
...
- [tools/sbom-publish/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tools/sbom-publish/Cargo.toml); blob `d314f370f0d40e2aed897a340d72ae17ee2db611`.
- [tools/sbom-publish/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tools/sbom-publish/src/lib.rs); blob `39b8df63b2560125204d129faec1afff82b76803`.
- [tools/sbom-publish/src/main.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tools/sbom-publish/src/main.rs); blob `8f6386b5753e8596bcaaaf2169e012b6e19627df`.
