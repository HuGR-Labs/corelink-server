...
**Manifesto:** `tools/dt-reconcile/Cargo.toml`. **Baseline:** `37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5`.
...
1 targets enumerados no [censo completo](../census.json), registro cujo `manifest` é `tools/dt-reconcile/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`tools/dt-reconcile/src/main.rs`](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tools/dt-reconcile/src/main.rs)
...
- [tools/dt-reconcile/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tools/dt-reconcile/Cargo.toml); blob `1f0730263886e0639bd808ee3a5ccf2d0a0524ca`.
- [tools/dt-reconcile/src/main.rs](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tools/dt-reconcile/src/main.rs); blob `a9a35d157874e618eae8dd8ba7ef597e8013d1b1`.
