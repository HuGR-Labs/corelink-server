...
**Manifesto:** `tests/e2e-user-journeys/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
1 targets enumerados em `../census.json`, registro cujo `manifest` é `tests/e2e-user-journeys/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`tests/e2e-user-journeys/src/main.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-user-journeys/src/main.rs)
...
- [tests/e2e-user-journeys/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-user-journeys/Cargo.toml); blob `3cae29b6a03d8baa2e0f56c3bbd9e4fec7cc0218`.
- [tests/e2e-user-journeys/src/main.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-user-journeys/src/main.rs); blob `70f466a699b5964347b0a90c6ddadce8fe2abff2`.
