...
**Manifesto:** `crates/corelink-adapters-vault/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
1 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-adapters-vault/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-adapters-vault/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-adapters-vault/src/lib.rs)
...
- [crates/corelink-adapters-vault/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-adapters-vault/Cargo.toml); blob `a57a5843e6af614b8b5af8aab49c593351ea2864`.
- [crates/corelink-adapters-vault/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-adapters-vault/src/lib.rs); blob `3b3fa5021e280f2d2ae3269fcabf5fbb19fd1bf1`.
