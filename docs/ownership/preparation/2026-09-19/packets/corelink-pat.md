...
**Manifesto:** `crates/corelink-pat/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
9 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-pat/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-pat/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-pat/src/lib.rs)
...
- [crates/corelink-pat/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-pat/Cargo.toml); blob `ecea00dee03d3d9e3306c2dc695c620c8b81a210`.
- [crates/corelink-pat/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-pat/src/lib.rs); blob `05e007ea176e5badfd12cb92d1ad85f895b799c6`.
