...
**Manifesto:** `crates/corelink-tier-selection/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
4 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-tier-selection/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-tier-selection/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-tier-selection/src/lib.rs)
...
- [crates/corelink-tier-selection/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-tier-selection/Cargo.toml); blob `ac742611a84dfdbc64a368762b5e92cb4bf6a836`.
- [crates/corelink-tier-selection/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-tier-selection/src/lib.rs); blob `ca4ff79f9e120570f81e2c46a8d97496a59cc275`.
