...
**Manifesto:** `tests/e2e-resilience/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
2 targets enumerados em `../census.json`, registro cujo `manifest` é `tests/e2e-resilience/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`tests/e2e-resilience/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-resilience/src/lib.rs)
...
- [tests/e2e-resilience/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-resilience/Cargo.toml); blob `7624e8c45e663ad6e26ef0b886a1d472fa90cc10`.
- [tests/e2e-resilience/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-resilience/src/lib.rs); blob `12ad92f053e0c263021720b6f388cbe20282c723`.
