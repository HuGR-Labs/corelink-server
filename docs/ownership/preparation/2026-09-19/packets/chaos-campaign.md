...
**Manifesto:** `tests/chaos/Cargo.toml`. **Baseline:** `37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5`.
...
12 targets enumerados no [censo completo](../census.json), registro cujo `manifest` é `tests/chaos/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`tests/chaos/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tests/chaos/src/lib.rs)
...
- [tests/chaos/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tests/chaos/Cargo.toml); blob `1f970e9ba5628054dc98aa0c6a43227087e27bce`.
- [tests/chaos/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/37f96dba42cc159cd8ab8e9c4ab9d35b8e5634b5/tests/chaos/src/lib.rs); blob `3ed5d277170ae5b80f171d1c440797e18f6a2759`.
