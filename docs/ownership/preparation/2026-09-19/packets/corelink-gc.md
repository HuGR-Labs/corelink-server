...
**Manifesto:** `crates/corelink-gc/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
16 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-gc/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-gc/src/bin/gc_sweep.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-gc/src/bin/gc_sweep.rs)
- [`crates/corelink-gc/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-gc/src/lib.rs)
...
- [crates/corelink-gc/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-gc/Cargo.toml); blob `26c58af62284c2fba62559ae1270d88969856303`.
- [crates/corelink-gc/src/bin/gc_sweep.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-gc/src/bin/gc_sweep.rs); blob `b6fd7bf7f9d62ac2ce1dfdb236286f28177e39ab`.
- [crates/corelink-gc/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-gc/src/lib.rs); blob `a90ca4ba9de9b10d9a17bc14d764a21840765ebf`.
