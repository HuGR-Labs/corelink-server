...
**Manifesto:** `crates/corelink-handler-cas/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
3 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-handler-cas/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-handler-cas/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-handler-cas/src/lib.rs)
...
- [crates/corelink-handler-cas/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-handler-cas/Cargo.toml); blob `ea5d3bf8274c29123ce0ecd7e0a5b9c5e40d72ed`.
- [crates/corelink-handler-cas/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-handler-cas/src/lib.rs); blob `f54c2425b3c509a715451f400cb74485b57c1edf`.
