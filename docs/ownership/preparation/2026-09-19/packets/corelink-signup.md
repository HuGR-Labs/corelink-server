...
**Manifesto:** `crates/corelink-signup/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
5 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-signup/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-signup/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-signup/src/lib.rs)
...
- [crates/corelink-signup/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-signup/Cargo.toml); blob `cc2da2df3e08ccb109fb95ef06c9d256e1762312`.
- [crates/corelink-signup/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-signup/src/lib.rs); blob `44192a950718830490f183adbf77f8e397041d81`.
