...
**Manifesto:** `tests/e2e-signup-flow/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
7 targets enumerados em `../census.json`, registro cujo `manifest` é `tests/e2e-signup-flow/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`tests/e2e-signup-flow/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-signup-flow/src/lib.rs)
...
- [tests/e2e-signup-flow/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-signup-flow/Cargo.toml); blob `67c5e30446e8ac0274a33498d13a0c5d5d106c10`.
- [tests/e2e-signup-flow/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/tests/e2e-signup-flow/src/lib.rs); blob `e87fc46f91ad21ff6e8d0935ef5445136bcebd6b`.
