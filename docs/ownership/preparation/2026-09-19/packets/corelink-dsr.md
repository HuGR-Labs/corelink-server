...
**Manifesto:** `crates/corelink-dsr/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
2 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-dsr/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-dsr/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-dsr/src/lib.rs)
...
- [crates/corelink-dsr/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-dsr/Cargo.toml); blob `d7250a943771103c399bd8848c4aa98492190988`.
- [crates/corelink-dsr/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-dsr/src/lib.rs); blob `9499a36d58012395ae7464ec961fa96af28ab64a`.
