...
**Manifesto:** `crates/corelink-dual-approval/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
8 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-dual-approval/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-dual-approval/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-dual-approval/src/lib.rs)
...
- [crates/corelink-dual-approval/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-dual-approval/Cargo.toml); blob `e5768c57539ac0003001fdc5e1188f183f7f6326`.
- [crates/corelink-dual-approval/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-dual-approval/src/lib.rs); blob `7d544552aa01f84eda9b0134b03a0ce7e0ed4ffa`.
