...
**Manifesto:** `crates/corelink-wasm/Cargo.toml`. **Baseline:** `cca798ff5bc2df660ecf2570ed243eb9775ff3d0`.
...
1 targets enumerados em `../census.json`, registro cujo `manifest` é `crates/corelink-wasm/Cargo.toml`. Abaixo estão apenas as entradas de implementação, não uma substituição do inventário completo.

- [`crates/corelink-wasm/src/lib.rs`](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-wasm/src/lib.rs)
...
- [crates/corelink-wasm/Cargo.toml](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-wasm/Cargo.toml); blob `4e75f8086e056d2d7733b12c0a04a95ba4c82943`.
- [crates/corelink-wasm/src/lib.rs](https://github.com/HuGR-Labs/corelink-server/blob/cca798ff5bc2df660ecf2570ed243eb9775ff3d0/crates/corelink-wasm/src/lib.rs); blob `8541493e4d1203dad46c217f1d6913760e9f11b7`.
