...
The current population is 315 items: 15 open, 261 done and 39 parked. The 15
...
parked-count: 39
catalog-counts: B001-B045=6,B046-B090=3,B091-B130=3,B131-B315=3
```
...
| [`work-packages/B131-B167.md`](work-packages/B131-B167.md) | B-131..B-315 | 3 |
| **Total** | | **15** |

The logical base includes the current B-008/B-012/B-013/B-032/B-035/B-039,
B-065/B-086/B-089, B-097/B-110/B-111 and B-154/B-170/B-314 open population.
