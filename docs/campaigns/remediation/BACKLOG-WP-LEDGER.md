...
The current population is 348 items: 16 open, 294 done and 38 parked. The 16
...
parked-count: 38
catalog-counts: B001-B045=6,B046-B090=3,B091-B130=3,B131-B348=4
```
...
| [`work-packages/B131-B167.md`](work-packages/B131-B167.md) | B-131..B-348 | 4 |
| **Total** | | **16** |
