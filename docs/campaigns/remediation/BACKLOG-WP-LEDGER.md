...
The current population is 320 items: 16 open, 265 done and 39 parked. The 16
...
parked-count: 39
catalog-counts: B001-B045=6,B046-B090=3,B091-B130=3,B131-B320=4
```
...
| [`work-packages/B131-B167.md`](work-packages/B131-B167.md) | B-131..B-320 | 4 |
| **Total** | | **16** |
