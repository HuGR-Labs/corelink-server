...
`docs/knowledge/` is the **code-grounded architecture wiki** — **172 OKF concepts**
...
- `python3 scripts/validate_specs.py` → **487 full-schema + 11 YAML-only (498 total), 0 failures** (counts are produced by the validator, not a hand-maintained gate).
