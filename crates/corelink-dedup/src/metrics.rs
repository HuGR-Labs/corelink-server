...
/// Mirrors [`crate::audit::DedupAuditOutcome`] — kept as a separate
...
pub trait DedupMetricsObserver: Send + Sync + core::fmt::Debug {
    ...
    /// [`crate::write::ChunkWriteOutcome::Inserted`] arm).
    ///
    /// # Errors
    ///
    ...
    /// upsert path (the [`crate::write::ChunkWriteOutcome::Reused`]
    /// arm).
    ///
    /// # Errors
    ///
