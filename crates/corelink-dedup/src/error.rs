...
use crate::audit::DedupAuditSinkError;
use crate::metrics::DedupMetricsObserverError;

/// Canonical errors surfaced by [`crate::index::DedupIndex`] +
/// [`crate::write::record_chunk_write`].
#[derive(Debug, Error)]
#[non_exhaustive]
pub enum DedupError {
    ...
    /// Caller supplied a batch size > [`crate::index::MAX_FIND_MISSING_BATCH_SIZE`].
