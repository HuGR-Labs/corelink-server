...
//!
//! 1. The Merkle root computed via [`crate::merkle::build_root`].
//! 2. The 102-byte canonical preimage assembled via
//!    [`Manifest::canonical_bytes`].
//! 3. The HKDF-SHA256 + BLAKE3 keyed-hash signature computed via
//!    [`crate::sig::ManifestSigner::sign`] over that preimage.
//!
//! ## Bounded parser
//!
//! The builder enforces every cap from [`crate::bounds`]:
//!
...
//!   [`crate::error::ManifestError::Empty`])
//!
...
use crate::merkle::build_root;
use crate::sig::ManifestSigner;
use crate::types::{
