...
use crate::lru_tracker::audit::LruAuditSinkError;
use crate::lru_tracker::metrics::LruMetricsObserverError;

/// Canonical errors surfaced by [`crate::lru_tracker::tracker::LruTracker`] +
/// [`crate::lru_tracker::tracker::InMemoryLruTracker`].
#[derive(Debug, Error)]
#[non_exhaustive]
pub enum LruError {
