...
//! emitted [`crate::chunker::Chunk<'a>`] borrows from the staging buffer.

use crate::chunker::bounds::{
...
pub struct FastCdcChunker {
    ...
    chunks_emitted: u32,
    /// Sticky drain flag (mirrors [`crate::chunker::fixed::FixedChunker::pending_drain`]).
    pending_drain: bool,
...
impl FastCdcChunker {
    /// Build a chunker with the canonical defaults from [`crate::chunker::bounds`].
    #[must_use]
    ...
    /// [`crate::chunker::ChunkerConfig::validate`] upstream).
    #[must_use]
