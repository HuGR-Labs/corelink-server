...
//! the [`crate::dedup::index::DedupIndex`] trait (which is the read seam, not
//! the write seam).
//!
//! ## Contract
//!
...
//! semantic via [`crate::dedup::index::InMemoryDedupIndex::upsert_chunk`]
...
//! the [`crate::dedup::DedupMetricsObserverError`] so the caller can decide
...
use crate::dedup::metrics::DedupMetricsObserver;
...
impl ChunkWriteOutcome {
    ...
    /// [`crate::dedup::index::InMemoryDedupIndex::upsert_chunk`] (`true` =>
...
/// succeeded). The test fixtures use [`crate::dedup::metrics::FailingDedupMetrics`]
