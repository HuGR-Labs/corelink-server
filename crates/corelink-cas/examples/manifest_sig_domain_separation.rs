...
use corelink_cas::manifest::HKDF_INFO_MANIFEST_SIG;
use uuid::Uuid;
...
fn main() {
    ...
    println!(
        ...
        std::str::from_utf8(corelink_cas::manifest::HKDF_INFO_META_MANIFEST_SIG_RESERVED)
            .unwrap_or("<binary>"),
        corelink_cas::manifest::HKDF_INFO_META_MANIFEST_SIG_RESERVED.len()
    );
