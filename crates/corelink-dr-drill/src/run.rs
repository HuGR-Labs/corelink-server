...
///
/// ```
/// use corelink_dr_drill::DrillStatus;
///
...
///
/// ```
/// use corelink_dr_drill::RtoRpoMeasurement;
///
...
impl RtoRpoMeasurement {
    ...
    pub fn within_slo(self) -> bool {
        self.rto_seconds <= crate::outage::RTO_CEIL_SECONDS
            && self.rpo_seconds <= crate::outage::RPO_CEIL_SECONDS
    }
}
...
///
/// ```
/// use corelink_dr_drill::{DrillCycle, DrillEnv, DrillRun, DrillStatus, Region, SloImpact};
///
/// let run = DrillRun {
