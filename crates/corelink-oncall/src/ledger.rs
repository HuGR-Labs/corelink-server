...
use crate::audit::{OncallAuditEventType, OncallAuditRecord, OncallAuditSink};
use crate::engineer::EngineerId;
use crate::error::OncallError;
use crate::page::{FatigueScore, FatigueWindow, PageEvent};
use crate::pagerduty::{PagerDutyAssignment, PagerDutyClient, PagerDutyScheduleKey};
use crate::rotation::{Rotation, Shift};
use crate::severity::Severity;
use crate::threshold::{decide_handoff, FatigueThreshold, HandoffDecision};
use crate::tier::Tier;
...
mod tests {
    use super::*;
    use crate::audit::{FailingOncallAuditSink, InMemoryOncallAuditSink};
    use crate::pagerduty::{FailingPagerDutyClient, InMemoryPagerDutyClient};
    use crate::rotation::ShiftId;
    use crate::SHIFT_CAP_SECONDS;
