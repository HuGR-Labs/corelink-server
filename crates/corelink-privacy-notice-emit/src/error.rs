...
/// Error returned by the audit sink [`crate::audit::NoticeAuditSink::emit`].
...
/// Error returned by the store [`crate::store::NoticeStateStore`].
///
/// `#[non_exhaustive]` per Lote 10.9-quinquies.
#[derive(Debug, Error)]
#[non_exhaustive]
...
/// Top-level error taxonomy for [`crate::emitter::NoticeEmitter`].
///
/// `#[non_exhaustive]` per Lote 10.9-quinquies.
#[derive(Debug, Error)]
#[non_exhaustive]
