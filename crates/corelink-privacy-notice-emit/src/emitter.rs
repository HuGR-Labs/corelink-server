...
use crate::audit::{NoticeAuditRecord, NoticeAuditSink};
use crate::error::{NoticeEmitterError, NoticeStoreError};
use crate::event::{
    canonical_notice_locales, NoticeDeprecatedPayload, NoticeLocale,
    NoticePublishedPayload, NoticeVersion, VersionBump,
};
use crate::store::{NoticePublicationState, NoticeStateStore};
            ...
            request
                ...
                .map(|(locale, content)| {
                    (
                        ...
                        crate::event::notice_text_hash(content),
                    )
                })
                .collect();
...
mod tests {
    use super::*;
    use crate::audit::{FailingNoticeAuditSink, InMemoryNoticeAuditSink};
    use crate::store::InMemoryNoticeStateStore;
    use uuid::Uuid;
