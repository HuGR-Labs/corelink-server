...
use crate::ports::{CasError, SharedCasStore, SharedTenantResolver};
use crate::translate::key_from_path;
...
pub fn build_router(config: CargoAdapterConfig) -> Router {
    ...
    let state = CargoRouterState {
        cas: Arc::<dyn crate::ports::CasStore>::clone(&config.cas),
        tenant_resolver: Arc::<dyn crate::ports::TenantResolver>::clone(
