...
impl AtomicCasState for OneShotRaceState {
    fn lookup(
        ...
        corelink_quota_cas::AtomicCasStateError,
    > {
    ...
    fn try_commit_delta(
        ...
        delta_bytes: u64,
    ) -> Result<AtomicTenantBytesState, corelink_quota_cas::AtomicCasStateError>
    {
        ...
        if !*g {
            *g = true;
            ...
            let cur = self
                ...
                .ok_or(corelink_quota_cas::AtomicCasStateError::Missing {
                    tenant_id,
    ...
    ) -> Result<(), corelink_quota_cas::AtomicCasStateError> {
...
fn retry_after_at_canonical_boundary_cases() {
    ...
    use corelink_quota_cas::retry_after::compose_utc;
