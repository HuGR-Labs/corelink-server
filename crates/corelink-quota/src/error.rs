...
use crate::audit::QuotaAuditSinkError;
use crate::metrics::QuotaMetricsObserverError;
use crate::reservation::ReservationTrackerError;

/// Canonical errors surfaced by [`crate::check::QuotaCheck`] +
/// [`crate::reservation::ReservationTracker`].
#[derive(Debug, Error)]
#[non_exhaustive]
pub enum QuotaError {
