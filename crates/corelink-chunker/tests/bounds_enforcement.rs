...
//! would exceed [`corelink_chunker::bounds::MAX_BLOB_SIZE`] (160 GiB)
//! or [`corelink_chunker::bounds::MAX_CHUNKS_PER_BLOB`] (81 920) BEFORE
...
//! MUST trip [`corelink_chunker::ChunkerError::TooManyChunks`].
//!
