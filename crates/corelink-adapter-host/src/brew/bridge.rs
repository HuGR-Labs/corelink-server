//! Bridges for the absorbed brew adapter's port traits.
//!
...
/// Bridges the brew adapter's `CasStore` port onto the workspace
...
/// Bridges the brew adapter's `TenantResolver` port onto the
