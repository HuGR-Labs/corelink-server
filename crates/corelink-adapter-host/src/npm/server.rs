...
//!
//! Wires the pure-logic handlers in [`crate::npm::metadata`] /
//! [`crate::npm::tarball`] into the HTTP surface. The router is
...
use crate::npm::config::NpmAdapterConfig;
use crate::npm::error::NpmAdapterError;
use crate::npm::metadata::serve_metadata;
use crate::npm::tarball::serve_tarball;
