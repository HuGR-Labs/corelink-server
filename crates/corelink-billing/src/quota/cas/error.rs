...
use super::audit::QuotaCasAuditSinkError;
use super::metrics::QuotaCasMetricsObserverError;
use super::state::AtomicCasStateError;

/// Canonical errors surfaced by [`super::cas::AtomicQuotaChecker`] +
/// [`super::state::AtomicCasState`].
#[derive(Debug, Error)]
#[non_exhaustive]
