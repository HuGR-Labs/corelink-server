...
//! - Endpoints: one POST per [`crate::stream::EvidenceStream`] variant
//!   (see [`crate::stream::EvidenceStream::endpoint_path`]).
...
//!   [`crate::audit::SyncAuditSink`] BEFORE/AFTER — this client is the
...
impl core::fmt::Debug for DrataHttpClient {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.debug_struct("DrataHttpClient")
            ...
            .field("api_key", &crate::redact::redact_api_key(&self.api_key))
...
impl DrataHttpClient {
    ...
    pub fn api_key_redacted(&self) -> String {
        crate::redact::redact_api_key(&self.api_key)
    }
}
...
mod tests {
    use super::*;
    use crate::record::record_sha256;
