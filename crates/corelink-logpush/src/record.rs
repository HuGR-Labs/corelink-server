...
//! [`crate::redaction::PiiRedactor::redact`]; the
//! [`crate::sink::InMemoryLogSink`] orchestrator enforces this at the
...
impl LogRecord {
    ...
    /// [`crate::sink::InMemoryLogSink`] orchestrator enforces this
