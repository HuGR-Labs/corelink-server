...
use crate::error::{LogSinkError, LogpushError};
use crate::record::{LogEventType, LogRecord};
use crate::redaction::{PiiRedactor, RedactionOutcome};
...
mod tests {
    ...
    use crate::redaction::InMemoryPiiRedactor;
    use serde_json::json;
    use uuid::Uuid;
