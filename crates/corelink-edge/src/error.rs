...
use crate::audit::EdgeAuditSinkError;
use crate::cidr::CidrParseError;
use crate::metrics::EdgeMetricsObserverError;

/// Canonical errors surfaced by [`crate::policy::EdgePolicy`] and
/// [`crate::blocklist::CidrBlocklist`].
#[derive(Debug, Error)]
#[non_exhaustive]
pub enum EdgeError {
