...
//!    [`crate::SurveyResponse`] constructors enforce this when used,
...
//! returns [`crate::SurveyError::AuditEmitFailed`] and DOES NOT
...
use crate::hash::RecipientHash;
use crate::ids::{SurveyId, TenantId};
use crate::signer::{mint_token, SigningKey, SurveyLinkSigner};
use crate::token::{decode_and_verify, SurveyToken};
use crate::types::{
