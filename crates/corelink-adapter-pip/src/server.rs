...
//!
//! Wires the pure-logic handlers in [`crate::index`] / [`crate::wheel`]
...
use crate::audit::{emit_pip_audit, event_types, now_unix_ms};
use crate::config::PipAdapterConfig;
use crate::error::PipAdapterError;
use crate::index::{serve_index, IndexFormat};
use crate::pep503_html::{parse_json_index, ProjectIndex};
use crate::upstream::UpstreamClient;
use crate::wheel::serve_wheel;
...
async fn handle_wheel(
    ...
    let kv_key = crate::index::kv_key_for_project(&project);
...
fn derive_project(filename: &str) -> String {
    let raw = filename
        ...
        .unwrap_or(filename)
        .to_owned();
    crate::pep503_html::normalise_project_name(&raw)
}
