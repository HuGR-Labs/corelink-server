...
//! [`crate::server`] is a thin wrapper that adapts `axum`
...
use crate::pep503_html::{encode_html, parse_json_index, ProjectIndex};
use crate::ports::KvStoreHandle;
...
pub fn kv_key_for_project(project: &str) -> String {
    format!(
        "pip:idx:{}",
        crate::pep503_html::normalise_project_name(project)
    )
}
