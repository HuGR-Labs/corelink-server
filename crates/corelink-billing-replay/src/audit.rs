...
use crate::error::ReplayAuditSinkError as ReplayAuditEmitErrorInner;
use crate::event::{LayerDriftSummary, ReplayDecision, ReplayReason};
...
/// [`crate::error::ReplayAuditSinkError`]).
pub use crate::error::ReplayAuditSinkError as ReplayAuditEmitError;
