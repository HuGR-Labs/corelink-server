...
use crate::assertion::{AssertionCeilings, CanaryLatenciesMs};
use crate::audit::{CanaryAuditRecord, CanaryAuditSink};
use crate::config::{DISPATCH_LAG_SEV3_MS, SYNTHETIC_CANARY_TENANT_ID};
use crate::error::CanaryError;
use crate::region::CanaryRegion;
use crate::result::{CanaryDecision, CanaryLoopResult, ObservabilityHealthReport};
...
trait FirstBreachOrDefault {
    fn unwrap_or_default_breach(self) -> crate::assertion::CanaryAssertion;
}

impl FirstBreachOrDefault for Option<crate::assertion::CanaryAssertion> {
    fn unwrap_or_default_breach(self) -> crate::assertion::CanaryAssertion {
        ...
        self.unwrap_or(crate::assertion::CanaryAssertion::CasPutP99)
    }
}
...
mod tests {
    use super::*;
    use crate::audit::{CanaryAuditEventType, FailingCanaryAuditSink, InMemoryCanaryAuditSink};
