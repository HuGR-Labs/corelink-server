...
/// use corelink_byok::revocation::testutil::StubKmsProvider;
///
...
impl KmsProvider for StubKmsProvider {
    ...
    fn fips_level(&self) -> crate::FipsLevel {
        crate::FipsLevel::None
    }
...
/// use corelink_byok::revocation::testutil::NoopAlerter;
///
/// # tokio_test::block_on(async {
...
/// use corelink_byok::revocation::CustomerAlerter;
/// use corelink_byok::revocation::alerter::RevocationAlertPayload;
/// use corelink_byok::revocation::testutil::RecordingAlerter;
///
/// # tokio_test::block_on(async {
