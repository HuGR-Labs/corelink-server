...
//!
//! This module was the standalone `corelink-byok-revocation` crate
//! prior to the Wave 35 Phase 2 BYOK umbrella absorption. The crate-
//! level `#![forbid(unsafe_code)]` attribute is now declared once at
//! the umbrella's `lib.rs`.
