...
//!    [`super::state::TenantOffboardingTransition::resolve`] table.
//!    Illegal → return
//!    [`super::error::TenantOffboardingError::IllegalTransition`];
//!    no audit row.
