...
//! domain row to an [`super::record::EvidenceRecord`], and hands the
...
use super::audit::{SyncAuditError, SyncAuditEvent, SyncAuditOutcome, SyncAuditSink};
use super::drata::{DrataClient, DrataClientError};
use super::ledger::{IdempotencyLedger, LedgerEntry, LedgerError};
use super::record::{record_sha256, EvidenceRecord};
...
impl SyncRunner {
    ...
    /// caller pre-redacts via [`super::redact::redact_api_key`].
    pub fn new(
        drata: Arc<dyn DrataClient>,
        ledger: Arc<dyn IdempotencyLedger>,
        audit: Arc<dyn SyncAuditSink>,
