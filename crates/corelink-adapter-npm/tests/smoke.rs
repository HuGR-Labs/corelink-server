...
fn make_state() -> AdapterState {
    let cas: Arc<dyn corelink_adapter_npm::ports::CasStore> = Arc::new(InMemCas::default());
    let kv: Arc<dyn corelink_adapter_npm::ports::KvStore> = Arc::new(InMemKv::default());
