...
use corelink_config_api::handlers::{AdminContext, PutConfigRequest, handle_get_current, handle_put};
    ...
    loop {
        ...
        match result {
            ...
            Err(ref e)
                if matches!(
                    e,
                    corelink_config_api::ApiError::Config(ConfigError::VersionConflict { .. })
                ) =>
            {
