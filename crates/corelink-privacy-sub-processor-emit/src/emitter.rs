...
use crate::audit::{SubProcessorAuditRecord, SubProcessorAuditSink};
use crate::broadcast::BroadcastStore;
use crate::error::SubProcessorEmitError;
use crate::event::{
...
use crate::event::ObjectionDecision;
use crate::objection::{ObjectionStore, ObjectionTicket};
...
pub fn make_broadcast_entry(
    ...
    locale: crate::event::EmailLocale,
    enqueued_at: &str,
) -> BroadcastLogEntry {
    BroadcastLogEntry {
