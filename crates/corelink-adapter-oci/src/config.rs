...
use crate::ports::{BlobStore, ManifestKvStore, TenantResolver};
...
/// Config-time errors (separate from runtime [`crate::error::OciAdapterError`]).
...
mod tests {
    use super::*;
    use crate::ports::testing::{InMemoryBlobStore, InMemoryKv, StaticTenantResolver};
