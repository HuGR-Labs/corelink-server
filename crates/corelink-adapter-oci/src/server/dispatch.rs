...
//! oci.md §2 and re-stated in [`crate::server`]'s route table.
...
/// # Errors
///
/// Returns [`crate::error::OciAdapterError::InvalidRepoName`] if any
/// component is empty, starts with a separator, or contains
/// forbidden chars.
pub fn validate_repo_name(name: &str) -> Result<(), crate::error::OciAdapterError> {
