...
use crate::config::{DatadogConfig, GrafanaCloudConfig, OtelCollectorConfig};
use crate::error::ExporterError;
use crate::metric::{MetricPoint, TraceSpan};
...
mod tests {
    ...
    use super::*;
    use crate::audit::InMemoryExportFailedAuditSink;
    use crate::config::{DatadogSite, OtlpProtocol};
