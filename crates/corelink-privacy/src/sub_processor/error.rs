...
/// Error returned by [`SubProcessorAuditSink`][super::audit::SubProcessorAuditSink].
#[derive(Debug, Error)]
#[non_exhaustive]
...
/// Error returned by [`BroadcastStore`][super::broadcast::BroadcastStore].
#[derive(Debug, Error)]
#[non_exhaustive]
...
/// Error returned by [`ObjectionStore`][super::objection::ObjectionStore].
#[derive(Debug, Error)]
#[non_exhaustive]
