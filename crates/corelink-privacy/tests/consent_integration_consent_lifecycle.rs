...
fn ac007_locale_mismatch_rejects() {
    ...
    let valid = matches!(
        err,
        corelink_privacy::consent::ConsentLedgerError::LocaleMismatch(_)
    );
...
fn canonical_audit_event_strings_pinned() {
    use corelink_privacy::consent::canonical_consent_audit_event_strings;
...
fn canonical_purpose_count_is_12() {
    use corelink_privacy::consent::canonical_consent_purposes;
...
fn schema_version_constant() {
    use corelink_privacy::consent::consent_schema_version;
...
fn revocable_only_consent_basis() {
    use corelink_privacy::consent::{canonical_consent_purposes, schema::LegalBasis};
