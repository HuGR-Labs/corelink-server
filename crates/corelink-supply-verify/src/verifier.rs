...
///
/// ```no_run
/// use corelink_supply_verify::{verifier::SlsaProvenanceVerifier, types::{BuilderIdentity, SlsaAttestation}};
///
...
///
///     let verifier = corelink_supply_verify::verifier::DefaultSlsaVerifier::new();
...
fn validate_fulcio_cert_chain(sig: &crate::types::DsseSignature) -> Result<String, VerifyError> {
