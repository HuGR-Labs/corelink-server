...
Modul noch Go-Quellcode in diesem Repository. Der folgende Code
illustriert die geplante API; er lässt sich heute nicht per `go get`
beziehen. Um Interesse zu registrieren, kontaktieren Sie
...
//
// Heute nicht veröffentlicht; es gibt kein Paket zu beziehen. Diese
// Datei illustriert die geplante API. Nach der Veröffentlichung wären
// erforderlich:
//
