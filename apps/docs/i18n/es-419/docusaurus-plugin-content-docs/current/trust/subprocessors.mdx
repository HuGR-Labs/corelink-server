...
> **Last refreshed:** 2026-08-24. This page is **auto-generated** from
...
- **Sigstore (Linux Foundation)** — the former Worker OCI signing workflow was
  ...
  paths remain independently gated. It never receives customer data and is not
  a customer-data sub-processor; this entry records the narrow removal.
