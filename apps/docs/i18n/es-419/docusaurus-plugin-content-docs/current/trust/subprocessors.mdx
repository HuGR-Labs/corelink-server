...
- **Sigstore (Linux Foundation)** — release signing and transparency for CoreLink build artifacts; the former OCI lane was removed and release-chain use is separately gated
