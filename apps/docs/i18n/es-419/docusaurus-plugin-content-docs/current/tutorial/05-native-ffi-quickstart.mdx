...
código fuente Go en este repositorio. El código a continuación ilustra
la API planeada; no es algo que pueda obtener con `go get` hoy. Para
registrar interés, contacte a [support@humangr.com](mailto:support@humangr.com).
...
//
// No publicado hoy; no hay paquete para obtener. Este archivo
// ilustra la API planeada. Una vez publicado, requeriría:
//
