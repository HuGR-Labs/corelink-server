...
Go neste repositório. O código abaixo ilustra a API planejada; não é
algo que você pode obter com `go get` hoje. Para registrar interesse,
contate [support@humangr.com](mailto:support@humangr.com).
...
//
// Não publicado hoje; não há pacote para obter. Este arquivo
// ilustra a API planejada. Uma vez lançado, exigiria:
//
