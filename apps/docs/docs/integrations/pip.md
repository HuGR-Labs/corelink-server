...
|---|---|---|
| `401 Unauthorized` | Username is not `hugr`, or the password is not a `corelink_pat_0123456789ABCDEF.AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA.BBBBBBBBBBBBBBBBBBBBBA` PAT | Use `hugr` as the username and your PAT as the password |
