...
3. You copy-pasted a truncated or reformatted token — a valid PAT is the
   three dot-separated segments `corelink_<env>_<token_id>.<random_secret>.<hmac_sig>`
   in full; any edit to that string fails validation.
