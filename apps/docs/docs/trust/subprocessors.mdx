...
| --- | --- | --- | --- | --- | --- |
| 1 | **Cloudflare, Inc.** | Workers / R2 / D1 / DO / KV / Pages / Email | metadata, encrypted-blobs, audit-logs, telemetry | R2/DO tenant-pinned; D1 control-plane metadata global under SCC/TIA safeguards | [Cloudflare DPA](https://www.cloudflare.com/cloudflare-customer-dpa/) |
