...
- Closed B-270 through B-312 from the final D03 bundled Rust passes: repaired
  ...
  including the repository-wide residual sibling-module census, strict-Clippy
  closures, and restored extracted regression tests.
