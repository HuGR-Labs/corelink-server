...
| H-10 | **SOC 2 audit firm contract** + Drata subscription · readiness **83.7% internal / 96.4% Drata** (snapshot 2026-05-15, commit `f18acdc`); 33 GAPs · 1 blocking-GA closing D+30 · 9 major · 23 minor (GAP-22 LGPD Art. 33 §1º Implemented 2026-05-15 — `specs/_compliance/LGPD-RESIDENCY-ATTESTATION-2026-05-15.md` + DPO checklist + customer explainer `apps/docs/docs/explanation/residency/lgpd-brazil.mdx` + nightly verifier `scripts/verify-lgpd-residency.py`) — rollup `specs/_compliance/SOC2-EVIDENCE-ROLLUP-2026-05-15.md` + walkthrough `specs/_compliance/AUDITOR-WALKTHROUGH-SCRIPT.md` | R-5 day 0 | $50-95k | R5-3 |
