...
| A.5.21 | Managing information security in the ICT supply chain | Yes | I | SLSA L2 (self-hosted provenance) + Cosign + Rekor + SBOM CycloneDX + Dependency-Track + license allowlist + reproducible build. (L2, not L3: provenance is generated on the self-hosted fleet; a GitHub-managed isolated builder for L3 is deferred — see BACKLOG B-031) | — | `specs/03_architecture/security_model.md §6` |
...
| A.8.4 | Access to source code | Yes | I | GitHub branch protection + signed commits + Cosign + Rekor + SLSA L2 (self-hosted provenance). | — | `specs/03_architecture/security_model.md §6 CTRL-SUPPLY-001` |
