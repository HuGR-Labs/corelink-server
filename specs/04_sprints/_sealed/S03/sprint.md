...
- [x] Pentest adversarial: PAT forge + replay attack tested (EVT-040). _Evidence: `specs/_audits/sealed/2026-05-01-pentest-s03-internal.md §6.2`; zero HIGH/CRITICAL._
...
- [x] OWASP ASVS V2/V3 100% checklist pass (EVT-002). _Evidence: `specs/04_sprints/_sealed/S03/asvs-v2-v3-v4-v6-v8-checklist.md` published with V2/V3/V4/V6/V8 self-checklist; WAIVED items revalidation-bound to S-08/S-13/S-19/S-20._
...
- [x] RB-FM-160 (auth invalid storm) dry-run (EVT-017). _Evidence: `scripts/rb_fm_160_dry_run.sh` host-side cargo-driven dry-run + audit `specs/_audits/sealed/2026-05-01-rb-fm-160-dry-run.md`; staging 1000 req/s × 30 min run deferred per same revalidation trigger as DEFERRED rows above._
