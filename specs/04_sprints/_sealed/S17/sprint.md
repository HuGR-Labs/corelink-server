...
| S17-D6 | Game day quarterly cadence start + 1 tabletop exercise + chaos catalog cleanup + closing PRR | `specs/_audits/2026-XX-XX-game-day-q1.md` + `specs/04_sprints/_sealed/S17/PRR-S17.md` | 1 game day 4-hour tabletop exercise executed (4 scenarios library); chaos catalog refined post-1st run; PRR doc S-17 com 5-8 sign-offs canonical |
