...
- `docs.corelink.humangr.com/quickstart` + 5 blog posts technical deep dives + 3 case studies = decision support; SLA v1 contractual published = trust signal; TLA+ region_residency + cas_integrity + tenant_isolation + audit_immutability formal verification em CI = unique differentiator.
...
| S20-D5 | SLA contractual v1 published + DPA v1 signed 3 lighthouse | `legal/sla/v1.md` + `docs.corelink.humangr.com/sla` + `legal/dpa/v1.md` + `specs/_audits/2026-XX-XX-dpa-signed-3-lighthouse.md` | SLA v1 covering todos os SLOs; published em legal/ + docs portal; DPA v1 Legal externo reviewed; 3 lighthouse customers signed; ADR if waiver needed; EVT-044 |
...
- [ ] **SLA contractual v1 published** em `legal/sla/v1.md` + `docs.corelink.humangr.com/sla` (EVT-044).
...
- [ ] 5 blog posts published em staging blog (`docs.corelink.humangr.com/blog`).
