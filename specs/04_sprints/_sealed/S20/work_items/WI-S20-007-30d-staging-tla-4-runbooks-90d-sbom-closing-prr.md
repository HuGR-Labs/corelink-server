...
| 1.1.0 | 2026-05-14 | Gustavo (via Claude Opus 4.7) | SEAL implementation — deliverables produced: (a) `specs/_audits/sealed/2026-05-14-s20-30d-staging-evidence.md` 30d evidence framework (DRAFT pending observation window D+30..D+60); (b) 4 TLA+ runbook specs verified GREEN with TLC v1.8.0 SHA-256 pin per ADR-0042 §A1 — `signup_atomic` (57 distinct states), `dpa_versioning_grace` (174), `byok_kill_switch` (570), `residency_failover` (800); (c) `specs/_audits/sealed/2026-05-14-s20-sbom-90d-retention.md` SBOM 90d retention proof (R2 Object Lock GOVERNANCE; cosign signed; daily cron); (d) `specs/04_sprints/_sealed/S20/PRR-S20-CLOSING.md` closing PRR sub-doc of PRR-GA-001 (`doc_status: SEALED · work_status: CONDITIONALLY_APPROVED` per declared deferrals — SOC 2 Type I 6m post-GA + APAC + Apache 2.0 + Launch orchestration soft-gate); (e) `specs/_audits/sealed/2026-05-14-s20-adversarial-summary.md` cross-WI rollup 95 scenarios 100% mitigation. doc_status SEALED · work_status DONE. |
