...
| 1.4.0 | 2026-05-14 | Gustavo (via Claude Opus 4.7 P0 remediation agent) | **Lote 11.21 sprint-close round-1 P0 remediation** (audit `AUDIT-S20-SPRINT-CLOSE-R1` 7.2/10 → target SEAL). **P0-002 — TLA+ 4 canonical specs ambiguity resolved**: §6.1 DoD distinguishes 4 INVARIANT-level specs (`specs/tla/{tenant_isolation,cas_integrity,audit_immutability,gc_correctness}.tla`) from 4 RUNBOOK-level specs (`specs/03_architecture/tla+/runbooks/{signup_atomic,dpa_versioning_grace,byok_kill_switch,residency_failover}.tla`); both non-waivable per §19. **P0-S20-001 — 13 sign-off roster reconciled** in §5.1 R-S20-1 (Owner, Final Approver, Engineer Lead, QA Lead, Security Lead, Privacy Officer, Legal Counsel, Compliance Officer, Product Lead, SRE Lead, CTO, Architect, External Auditor); PRR-S20-GA §3 + WI tables reference §5.1 verbatim. Companion fixes: synthetic-pager PROPTEST_CASES runtime fn (P0-001); SOW per-surface ASVS L1/L2/L3 mapping (P0-S20-002); SOC2-GAP-ANALYSIS §12 CIS Controls v8 mapping (P0-S20-003). |
| 1.5.0 | 2026-05-14 | Gustavo (via Sonnet WI-S20-008 builder) | **WI-S20-008 SEALED** — launch orchestration prep (separated soft-gate; NÃO blocking engineering gate). Deliverables under `marketing/launch/`: PRESS-RELEASE.md PR-1 (embargo tied to Engineering Gate D-day + 24h); 5 launch blog posts (introducing / BYOK / audit-chain / multi-region / cache-hit economics); 3 case studies (forge customer-zero + oss DRAFT + enterprise-byok DRAFT); Product Hunt kit (PH-LAUNCH-PLAN/TAGLINE/DESCRIPTION/MAKER-COMMENT/FAQ); social kit (Twitter thread / LinkedIn / Show HN); COORDINATION/LAUNCH-RUNBOOK T-7d..T+7d; METRICS-DASHBOARD. All artifacts DRAFT pending Legal + Marketing + CEO sign-off; no specific $ amounts; no competitor disparagement. WI-S20-008 frontmatter SEALED/DONE v1.1.0. **S-20 FULL SPRINT WI CORPUS COMPLETE: 8/8 WIs SEALED — 7/7 Engineering Gate (binary GA-go blocking) + 1/1 Launch Orchestration (soft-gate). FINAL WI OF THE FINAL SPRINT OF CoreLink GA scope.** |
