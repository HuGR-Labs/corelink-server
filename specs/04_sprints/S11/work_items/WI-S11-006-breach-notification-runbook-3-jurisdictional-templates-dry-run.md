...
|---|---|---|---|
| 1.2.1 | 2026-05-15 | Gustavo (wave-18 customer email templates DONE) | **Wave-18 customer email templates DONE.** Landed 6 customer-readable markdown breach notification templates under `docs/customer-comm/breach-notification/v1.0.0/{pt-BR,en,es}/{audit-chain-integrity-incident,dsr-pipeline-temporary-degradation}.md` — covering 2 incident classes (audit-chain integrity SEV-0 triggered by wave-17 `corelink.audit.export_verify_failed.v1`; DSR pipeline loss-of-availability ≥ 24h SEV-1 triggered by `corelink.privacy.statuspage_publish_failed.v1`) × 3 locales. Statutory anchors: LGPD Art. 48 + Art. 46 (pt-BR), GDPR Art. 34 + Art. 33(3) + CCPA §1798.82 (en), LFPDPPP Art. 20-21 (Art. 21 primary anchor per task spec) + Arts. 22-26 ARCO (es). 87 Mustache placeholders total (14 Class-A + 15 Class-B per locale; 10 shared variables across classes). RB-BREACH-NOTIF §3.4 cross-ref appended. Audit doc landed at `specs/_audits/sealed/2026-05-15-customer-breach-notification-templates.md` with regulatory alignment matrix §2 + LFPDPPP Art. 20-21 disambiguation from wave-17-ter D-8 deferred Art. 10 VI drift (§2.1) + native-register translation verification §3 + dry-run plan §4 (wave-18-A + wave-18-B test cases wired to RB-BREACH-NOTIF §5 Q3 cadence). MX attorney sign-off pending (same review queue as wave-17-ter D-8). Non-breaking extension — WI-S11-006 sealed corpus unchanged; this is closure-class metadata. |
