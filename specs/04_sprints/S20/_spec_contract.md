...
| 1.4.0 | 2026-05-14 | Gustavo (via Sonnet WI-S20-008 builder) | **WI-S20-008 SEALED** — launch orchestration prep (separated soft-gate; NÃO blocking engineering gate binary GA-go decision per spec contract §1 codex finding + §6.2 + CAP-LAUNCH-001). Deliverables committed under `marketing/launch/`: (1) `PRESS-RELEASE.md` PR-1 DRAFT (embargo tied to Engineering Gate D-day + 24h, 5 quote slots CEO/CTO/2-lighthouse/1-analyst, BusinessWire primary / PR Newswire secondary, media contact press@corelink.dev); (2) `BLOG-POSTS/` 5 launch posts (01-introducing-corelink Stripe-style, 02-byok-deep-dive technical, 03-audit-chain-merkle-proofs RFC 6962 + RFC 8785, 04-multi-region-residency Schrems II + LGPD + GDPR, 05-fast-cache-hit-economics with calculator pointer); (3) `CASE-STUDIES/` (forge-team-tier customer-zero + oss-team-tier DRAFT pending engagement + enterprise-byok DRAFT pending Fortune-500 engagement; all per WI-S20-004 cumulative); (4) `PRODUCT-HUNT/` kit (PH-LAUNCH-PLAN, PH-TAGLINE 5+recommended, PH-DESCRIPTION 3 variants ≤ 260 chars, PH-MAKER-COMMENT, PH-FAQ); (5) `SOCIAL/` kit (TWITTER-THREAD 10 tweets + 5 alt-text image briefs, LINKEDIN-POST CEO voice, HACKERNEWS-SHOW-HN guidelines-compliant); (6) `COORDINATION/LAUNCH-RUNBOOK.md` (T-7d preconditions through T+7d retrospective); (7) `METRICS-DASHBOARD.md` (PR pickup + blog UVs + PH/HN rank + signup + Lighthouse + social velocity; ahrefs + GA + PH API + HN API + Twitter API + CoreLink internal Prometheus). All artifacts DRAFT pending Legal + Marketing + CEO sign-off; no specific dollar amounts ($X placeholders only); no competitor disparagement; all compliance claims trace to canonical spec sources or external Legal review path WI-S20-005. WI-S20-008 doc_status DRAFT → SEALED · work_status READY → DONE · version 1.0.0 → 1.1.0. **S-20 FULL SPRINT WI CORPUS COMPLETE: 8/8 WIs SEALED — 7/7 Engineering Gate (binary GA-go blocking) + 1/1 Launch Orchestration (soft-gate NÃO blocking). FINAL WI OF THE FINAL SPRINT OF CoreLink GA scope.** |
