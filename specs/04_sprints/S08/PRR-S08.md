...
| RB-FM-250 (DDoS volumetric) dry-run (EVT-017) | ✅ (host-side) | `scripts/rb_fm_250_dry_run.sh` host-side dry-run green; audit `specs/_audits/sealed/2026-05-02-rb-fm-250-dry-run.md`; runbook flipped DRAFT → FROZEN with dry-run-executed timestamp. Full staging dry-run with real CF DDoS-managed engagement + 100k QPS distributed flood + on-call exec deferred until staging account provisioned. |
...
4. RB-FM-250 host-side dry-run green; runbook flipped DRAFT →
   ...
   `specs/_audits/sealed/2026-05-02-rb-fm-250-dry-run.md`.
...
`specs/_audits/sealed/2026-05-02-adversarial-s08.md` (20 scenarios across
...
- `specs/_audits/sealed/2026-05-02-adversarial-s08.md` — per-WI adversarial
  scenario aggregation.
- `specs/_audits/sealed/2026-05-02-rb-fm-250-dry-run.md` — RB-FM-250
  dry-run audit trace.
