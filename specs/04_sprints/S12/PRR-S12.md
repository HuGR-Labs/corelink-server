...
| RB-FM-156 dry-run executado | ✅ | `specs/_audits/2026-05-13-rb-fm-156-dry-run.md` FROZEN; runbook `RB-FM-156-dep-maintainer-malicioso.md` FROZEN v1.0.0. |
| RB-FM-157 dry-run executado | ✅ | `specs/_audits/2026-05-14-rb-fm-157-dry-run.md` FROZEN; runbook `RB-FM-157-typosquat.md` promoted from stub to FROZEN v1.0.0. |
...
| OWASP ASVS V14 + V11.1 + SSDF + EO 14028 100% checklist | ✅ | `specs/04_sprints/S12/asvs-v14-v11.1-ssdf-eo14028-checklist.md` 100% pass. |
| Security walkthrough 2h sessão; P0=0; P1=0 | ✅ | `specs/_audits/2026-05-14-security-walkthrough-s12.md`; P0=0, P1=0, P2=1 (deferred). |
| Adversarial test summary 30+ scenarios | ✅ | `specs/_audits/2026-05-14-adversarial-summary-s12.md`; 30 scenarios, 100% mitigated. |
...
| RB-FM-156 dry-run report | `specs/_audits/2026-05-13-rb-fm-156-dry-run.md` | ✅ |
| RB-FM-157 FROZEN runbook | `specs/05_quality/runbooks/RB-FM-157-typosquat.md` | ✅ |
| RB-FM-157 dry-run report | `specs/_audits/2026-05-14-rb-fm-157-dry-run.md` | ✅ |
| Security walkthrough report | `specs/_audits/2026-05-14-security-walkthrough-s12.md` | ✅ |
| Adversarial summary report | `specs/_audits/2026-05-14-adversarial-summary-s12.md` | ✅ |
| OWASP ASVS + SSDF + EO 14028 checklist | `specs/04_sprints/S12/asvs-v14-v11.1-ssdf-eo14028-checklist.md` | ✅ |
...
Full report: `specs/_audits/2026-05-14-adversarial-summary-s12.md`.
