...
(*   (legacy pre-workspace path; post Wave 33 reorg the implementation     *)
(*    lives in crates/corelink-signup/src/{orchestrator,request,           *)
(*    idempotency}.rs)                                                     *)
...
(*   - `crates/corelink-signup/src/{orchestrator,request,idempotency}.rs` *)
(*     (current home; legacy monolith was `apps/server/src/routes/         *)
(*      signup.rs` at wave-29 commit b3c359f, pre Wave 33 reorg)           *)
