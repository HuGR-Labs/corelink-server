...
This wave-25 audit doc is the canonical closure for the deferred §7 caveat in `specs/_audits/2026-05-16-neon-shadow-real-driver.md` (wave-21 closure-note). The wave-21 doc is updated in the same commit to flip the §7 caveat to CLOSED-WAVE-25.
