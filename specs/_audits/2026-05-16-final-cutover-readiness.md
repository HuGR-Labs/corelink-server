...
| 5 | DEBT-016 Statuspage `status.corelink.dev` go-live | user-bound (ops) | Gustavo | engineering-CLOSED wave-24 (URL substitution mechanism); user-bound provisioning at T-7d per `STATUSPAGE-INIT.md` (DNS + ORG-ID swap only). |
