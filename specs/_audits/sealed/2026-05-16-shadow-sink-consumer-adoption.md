...
6. **Wave-26 audit doc caveat update** — `specs/_audits/sealed/2026-05-16-cf-worker-prefetch-wire.md` §9. Flip the "ShadowSinkFactory consumer adoption" caveat to **CLOSED-WAVE-27** with a forward pointer to this doc.
...
This wave-27 audit doc is the canonical closure for the deferred §9 caveat "Handler-chain ShadowSinkFactory dispatch wiring" in `specs/_audits/sealed/2026-05-16-cf-worker-prefetch-wire.md`. The wave-26 doc is updated in the same commit to flip the §9 caveat to **CLOSED-WAVE-27** with a forward pointer to this doc.
