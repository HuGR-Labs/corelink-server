...
| 2026-05-15 | v1.0.1 — DEBT-018 + DEBT-019 → CLOSED. 121 tag-pinned action refs across 14 workflow files SHA-pinned via `gh api`; verifier + CI gate added; baseline doc landed. | Gustavo (via Claude Opus 4.7 orchestrator, branch `wt/debt-018-019-action-sha-pin`) |
