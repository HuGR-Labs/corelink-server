...
| DEBT-013 | **10 perf optimization tickets — PARTIAL 3/10 (2026-05-15 wt/debt-013-perf-opt-01-03-v2):** OPT-01 (TenantPrefixCache), OPT-02 (audit-chain streaming JCS→blake3), OPT-05 (thread-local blake3::Hasher template substituted for infeasible OPT-03(a) — no JSON-deserialization call site exists on the AC read path). Remaining 7 (OPT-03(a) deferred, OPT-03(b), OPT-04 ph1+ph2, OPT-06, OPT-07, OPT-08) tracked in `specs/_audits/perf-optimization-followup-tickets.md`. | `specs/_audits/perf-optimization-followup-tickets.md` (commit `3b4cbfc`) + this branch | Orchestrator | T+60d (2026-07-14) | Dispatch remaining 7 as separate WIs in R-3/R-4 integration waves. Not blocking GA but blocking GA-Full. |
