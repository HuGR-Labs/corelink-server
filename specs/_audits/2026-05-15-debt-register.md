...
| DEBT-011 | **10 replication followup tickets** (3 P0 + 4 P1 + 3 P2) — RPO measurement gaps + Prometheus emit wiring for SLO-REPLICATION-LAG-*. **PARTIAL (3/10): 3 P0 CLOSED 2026-05-15 via wt/debt-011-replication-p0** (trait + InMemoryFake + verifier wiring; CF Worker production wiring still trait-deferred per charter). P1+P2 outstanding. | `specs/_audits/replication-followup-tickets.md` (commit `ed36bcd`); P0 closure: wt/debt-011-replication-p0 | Orchestrator | T+30d (2026-06-14) | 3 P0 done; dispatch 1 Sonnet on the 4 P1 (KV propagation + audit_outbox + DO sync-age + R2-CRR). P2 deferred to post-GA polish. |
