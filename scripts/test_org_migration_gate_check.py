...
def complete_ledger(now: datetime) -> dict:
    ...
    data['readback'] = {'status': 'OBSERVED', 'repository_id': 1232040291,
                        'owner': 'HuGR-dev', 'owner_id': 331432289,
                        'name': 'corelink-server', 'visibility': 'private',
                        'canonical_path': 'HuGR-dev/corelink-server',
    ...
    data['backup_restore'] = {
        ...
        'evidence_reference': 'private://backup-restore/receipt',
    }
    ...
    data['access_cleanup'] = {
        ...
        'source_bridge': {
            ...
            'destination_owner_id': 331432289,
