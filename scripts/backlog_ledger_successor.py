...
# validation at v0004. `base_commit` is deliberately not a static pin: the
# generic receipt transition binds it to the immutable trusted BASE event SHA.
# The pinned pre-state below prevents that dynamic binding from admitting a
# later or otherwise different BASE state.
