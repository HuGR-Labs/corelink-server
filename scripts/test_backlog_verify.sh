...
# the closed x owner corner, never on a legitimately blocked open item, and never
# on a closed item that is correctly owned. Without them a gate that BROKE
# everything would pass the two teeth cells above and look proven.
