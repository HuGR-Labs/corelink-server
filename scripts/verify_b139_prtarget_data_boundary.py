...
EXPECTED_CHECKOUTS = {
    "backlog-verify.yml": [("9f698171ed81b15d1823a05fc7211befd50c8ae0", "${{ github.event.pull_request.head.sha || github.sha }}", "_candidate", 1, False), ("9f698171ed81b15d1823a05fc7211befd50c8ae0", "${{ github.event.pull_request.base.sha || github.sha }}", "_base", 0, False)],
...
EXPECTED_DOCUMENT_DIGESTS = {
    "backlog-verify.yml": "456dcb9831f573cdbd973366ec0de3dc3a4b6575bc3bc83044dc1de0d19e495e",
    ...
    "secrets-drift.yml": "2271468f7b73d9daa62e8162dfbef74f4a864cc69553285d6a55ecbb693044f0",
