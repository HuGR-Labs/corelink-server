...
def validate_texts(probe: str, ci: str, signer: str, script: str, actionlint_config: str) -> list[str]:
    ...
    for required in (
        ...
        "github.event.pull_request.head.ref == 'codex/issue-2586-windows-readiness'",
        "github.event.pull_request.base.ref == 'main'",
        "github.ref == 'refs/heads/codex/issue-2586-windows-readiness'",
    ):
    ...
    binding_commands = {
        ...
        '[[ "$PR_HEAD_REF" == codex/issue-2586-windows-readiness ]]',
        '[[ "$PR_BASE_REF" == main ]]',
