...
require_pattern 'export CARGO_INCREMENTAL=0' 'incremental artifacts disabled for bounded CI target'
require_pattern 'export CARGO_PROFILE_DEV_DEBUG=0' 'dev profile debug info disabled for bounded CI target'
require_pattern 'export CARGO_PROFILE_TEST_DEBUG=0' 'test profile debug info disabled for bounded CI target'
