...
# - B251_OPERATION_SEED: deterministic per-run in-memory test input derived
#   from public workflow metadata, not a credential or retained raw value
