...
export interface Env {
  ...
  // Deployment identity is injected by the release environment and echoed on
  // diagnostic responses so an owner receipt cannot attach timings to an
  // unverified build or region.
